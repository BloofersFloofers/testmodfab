...
public class ModItems {
    ...
    public static final Item STONY_DIRT_BRICK = new Item(new Item.Settings().group(ItemGroup.MATERIALS));
    //block items
    ...
    public static void registerItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier(testmod.MOD_ID, "stony_dirt_brick"), STONY_DIRT_BRICK);
    }
